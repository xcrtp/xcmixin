...
XCMIXIN_REQUIRE(print_method, xcmixin_no_hiding(print);
                xcmixin_require_method(print);
                xcmixin_require_mixin(name_method);
                xcmixin_require_method(name, void););

XCMIXIN_REQUIRE(name_method, xcmixin_no_hiding(name, long);
                xcmixin_no_hiding(name, int, const_););

XCMIXIN_DEF_BEGIN(dosomethings1_method)
